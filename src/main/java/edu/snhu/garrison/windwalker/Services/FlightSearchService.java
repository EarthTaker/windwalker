...
/**
 * Service responsible for handling flight search logic and delegating data
...
public class FlightSearchService {
    ...
    /**
     * Searches for flights matching the criteria specified in the search
     * request.
     *
     ...
     * @return A List of FlightOption objects that match the route. Returns
     * empty list if no matches found.
     */
    public List<FlightOption> searchFlights(FlightSearchRequest searchRequest) {

        return flightRepository.findByDepartureCityIgnoreCaseAndArriveCityIgnoreCase(searchRequest.getFrom(), searchRequest.getTo());
    }
}
